            ...
            <div class="categories-menu">
                ...
                <div class="category-menu-list">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('product.index', ['cat_id'=>$cat->id]) }}"><img alt="" src="assets/img/icon-img/7.png"> {{ $cat->name }}<i class="pe-7s-angle-right"></i></a>
                            @php
                               $child = TCG\Voyager\Models\Category::where('parent_id', $cat->id)->get();
                            @endphp
                            ...
                            <div class="category-menu-dropdown">
                                ...
                                <div class="category-dropdown-style category-common3">
                                    <a href="{{ route('product.index', ['cat_id'=>$ch->id]) }}"><h4 class="categories-subtitle">{{ $ch->name }}</h4></a>
                                    @php
                                        $grandchild = TCG\Voyager\Models\Category::where('parent_id', $ch->id)->get();
                                    @endphp
                                    
                                    @if($grandchild->isNotEmpty())
                                    <ul>
                                    @foreach($grandchild as $gc)
                                        <li><a href="{{ route('product.index', ['cat_id'=>$gc->id]) }}"> {{$gc->name}}</a></li>
                                    @endforeach
                                    </ul>
                                    @endif
                                </div>
